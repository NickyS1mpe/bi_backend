...
import com.nick.springbootinit.model.dto.file.UploadFileRequest;
...
import com.nick.springbootinit.constant.FileConstant;
import com.nick.springbootinit.exception.BusinessException;
import com.nick.springbootinit.manager.CosManager;
import com.nick.springbootinit.model.entity.User;
import com.nick.springbootinit.model.enums.FileUploadBizEnum;
...
public class FileController {
    ...
    private void validFile(MultipartFile multipartFile, FileUploadBizEnum fileUploadBizEnum) {
        ...
        if (FileUploadBizEnum.USER_AVATAR.equals(fileUploadBizEnum)) {
            if (fileSize > ONE_M) {
                throw new BusinessException(ErrorCode.PARAMS_ERROR, "Size cannot be larger than 1M");
            }
